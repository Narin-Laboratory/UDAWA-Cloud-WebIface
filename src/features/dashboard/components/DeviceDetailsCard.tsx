        ...
        <Grid container spacing={2} alignItems="center">
          ...
          <Grid item sm={1} sx={{ display: { xs: 'none', sm: 'block' } }}>
            ...
            <Grid container spacing={1}>
              ...
              <Typography variant="body2">
                {typeof device?.attributesClientScope?.rssi?.[0]?.[1] === 'number'
                ? `${device.attributesClientScope.rssi[0][1]}%`
                : 'N/A'}
              </Typography>
              </Grid>
              <Grid item xs={6} sm={4}>
              ...
              <Typography variant="body2">
                {typeof device?.attributesClientScope?.batt?.[0]?.[1] === 'number'
                ? `${device.attributesClientScope.batt[0][1]}%`
                : 'N/A'}
              </Typography>
              </Grid>
              <Grid item xs={6} sm={4}>
