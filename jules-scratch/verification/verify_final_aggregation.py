...
def run():
    with sync_playwright() as p:
        ...
        # Set interval and interval type
        page.get_by_label("Interval").fill("1")
        page.get_by_label("Interval Type").click()
        page.get_by_role("option", name="Hours").click()

        # Change aggregation to SUM
        page.get_by_label("Aggregation").click()
        page.get_by_role("option", name="Sum").click()
        ...
        # Verify the "Sum" statistic is displayed
        expect(page.locator("text=Sum:")).to_be_visible(timeout=30000)

        # Take a screenshot
        page.screenshot(path="jules-scratch/verification/final_aggregation.png")
