...
def run():
    with sync_playwright() as p:
        ...
        # Wait for the key dropdown to be populated
        expect(page.locator("text=soc")).to_be_visible(timeout=30000)

        # Take a screenshot
        page.screenshot(path="jules-scratch/verification/key_population.png")
