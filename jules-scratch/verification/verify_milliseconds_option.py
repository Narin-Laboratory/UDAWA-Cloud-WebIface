...
def run():
    with sync_playwright() as p:
        ...
        # Open the interval type dropdown
        page.get_by_label("Interval Type").click()

        # Verify that the "Milliseconds" option is visible
        expect(page.get_by_role("option", name="Milliseconds")).to_be_visible(timeout=30000)

        # Take a screenshot
        page.screenshot(path="jules-scratch/verification/milliseconds_option.png")
